import{s as i,O as l}from"./chunks/theme.JIE6HSS9.js";import{d as f,o as p,a as u,m as t,w as s,q as r,H as o,_ as b,b as n,a6 as y,P as v}from"./chunks/framework.DQIZlQnU.js";import{S as g}from"./chunks/index.CrDYnhOj.js";const B=`<template>
  <div>
...
`,V=f({__name:"status",setup(m){const c=()=>{l({type:"success",content:"这是一条消息"})},e=()=>{l({type:"warning",content:"这是一条消息"})},d=()=>{l({type:"info",content:"这是一条消息"})},h=()=>{l({type:"danger",content:"这是一条消息"})};return(M,a)=>(p(),u("div",null,[t(o(i),{type:"success",onClick:c},{default:s(()=>a[0]||(a[0]=[r("success")])),_:1}),t(o(i),{type:"warning",onClick:e},{default:s(()=>a[1]||(a[1]=[r("warning")])),_:1}),t(o(i),{type:"info",onClick:d},{default:s(()=>a[2]||(a[2]=[r("info")])),_:1}),t(o(i),{type:"danger",onClick:h},{default:s(()=>a[3]||(a[3]=[r("error")])),_:1})]))}}),x=b(V,[["__scopeId","data-v-b2e5991c"]]),k=`<template>
  <div>
