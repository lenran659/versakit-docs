import{c as s,w as u,H as y,s as C}from"./chunks/theme.BrU2QKam.js";import{d as m,o,f as w,w as a,j as t,H as n,m as l,c as i,F as f,q as b,a as r,t as x,_,P as J,a6 as v}from"./chunks/framework.B4hMHHFJ.js";import{S as h}from"./chunks/index.CqP34_JU.js";const U=`<template>
  <ver-row>
...
<\/script>
`,D=m({__name:"shadow",setup(c){return(p,e)=>(o(),w(n(y),null,{default:a(()=>[t(n(u),{span:6,offset:2},{default:a(()=>[t(n(s),{shadow:"always"},{default:a(()=>e[0]||(e[0]=[l(" Always ")])),_:1})]),_:1}),t(n(u),{span:6,offset:2},{default:a(()=>[t(n(s),{shadow:"hover"},{default:a(()=>e[1]||(e[1]=[l(" Hover ")])),_:1})]),_:1}),t(n(u),{span:6,offset:2},{default:a(()=>[t(n(s),{shadow:"never"},{default:a(()=>e[2]||(e[2]=[l(" Never ")])),_:1})]),_:1})]),_:1}))}}),B=`<template>
  <div>
    <ver-card>
...
`,A=m({__name:"simple",setup(c){return(p,e)=>(o(),i("div",null,[t(n(s),null,{default:a(()=>[(o(),i(f,null,b(4,d=>r("div",{key:d,class:"text item"},x("List item "+d),1)),64))]),_:1})]))}}),k=_(A,[["__scopeId","data-v-96b061cb"]]),E=`<template>
  <div>
    <ver-card>
      <template #header>
