import{f as i,U as c}from"./chunks/theme.HzRXKWqu.js";import{d as g,o as u,c as d,Q as n,w as s,l,D as o,_ as B,N as y,a as t}from"./chunks/framework.BvQ8UnBS.js";import{S as f}from"./chunks/index.HR8TKol0.js";const C=`<template>
  <div>
...
`,k=g({__name:"status",setup(m){const p=()=>{i({type:"success",content:"这是一条消息"})},e=()=>{i({type:"warning",content:"这是一条消息"})},a=()=>{i({type:"info",content:"这是一条消息"})},V=()=>{i({type:"danger",content:"这是一条消息"})};return(_,r)=>(u(),d("div",null,[n(o(c),{type:"success",onClick:p},{default:s(()=>r[0]||(r[0]=[l("success")])),_:1}),n(o(c),{type:"warning",onClick:e},{default:s(()=>r[1]||(r[1]=[l("warning")])),_:1}),n(o(c),{type:"info",onClick:a},{default:s(()=>r[2]||(r[2]=[l("info")])),_:1}),n(o(c),{type:"danger",onClick:V},{default:s(()=>r[3]||(r[3]=[l("error")])),_:1})]))}}),U=B(k,[["__scopeId","data-v-b2e5991c"]]),T=`<template>
  <div>
