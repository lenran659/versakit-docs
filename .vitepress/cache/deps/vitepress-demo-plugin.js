...
// node_modules/.pnpm/vitepress-demo-plugin@1.1.2_vitepress@1.5.0_@algolia+client-search@5.15.0_postcss@8.4.49_sass_frrabtaliiua75cdobuprxsecm/node_modules/vitepress-demo-plugin/dist/index.js
...
var ao = (e) => {
  ...
  return "Temp" + btoa(encodeURIComponent(n.join("-").split(".").slice(0, -1).join("."))).replace(/=/g, "Equal");
};
var oo = /title="(.*?)"/;
var lo = /vue="(.*?)"/;
var _o = /html="(.*?)"/;
